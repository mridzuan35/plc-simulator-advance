...
const TRANSLATIONS = {
  en: {
    appTitle: "Pro PLC Simulator", homeDesc: "Web-Based PLC Ladder Logic and Process Control Training Simulator",
    inputs: "Inputs", outputs: "Outputs", memory: "Memory", system: "System",
    tabIo: "1. I/O Configuration", tabLadder: "2. Ladder Logic Editor", tabProcess: "🏭 3. 2D Process Plant",
    runSystem: "RUN SYSTEM", stopSystem: "STOP SYSTEM", resetSim: "↺ Reset Simulation",
    ioTagDb: "I/O Tag Database", ioDesc: "Define physical inputs and outputs. Click any Tag Name to rename it.",
    type: "Type", address: "Address", tagName: "Tag Name", addTag: "Add Tag",
    behavior: "Behavior", toggleSwitch: "Toggle Switch", pushButton: "Push Button", autoSensor: "Auto Sensor",
    physicalPanel: "Physical Panel", physicalDesc: "Toggle inputs and monitor output states.",
    dataRegPanel: "Data Registers", dataRegDesc: "Monitor intermediate data. Edit target values when stopped.",
    ladderProg: "Ladder Logic Editor", editMode: "Edit Mode", running: "Running", addRung: "+ Add Rung",
    noRungs: "No rungs defined. Click '+ Add Rung' to begin.", selectTarget: "Target...", preset: "Preset:",
    parallelDown: "+ Parallel ↓", outputDown: "+ Output ↓", processSim: "2D Process Simulation",
    processDesc: "Write the ladder logic required to control this plant!", bottles: "Bottles", conveyor: "Conveyor",
    valve: "Valve", motorUp: "Motor Up", motorDn: "Motor Dn", fillPump: "Fill Pump", drainPump: "Drain Pump",
    mixer: "Mixer", heater: "Heater", floor2: "Floor 2", floor1: "Floor 1", ground: "Ground", call: "Call",
    on: "ON", off: "OFF", photoEyeHelp: "Photo Eye (I:0/4) - Toggle on Left Panel", prox: "Prox", level: "Level",
    high: "High", low: "Low", loadTemplate: "Load Template", export: "💾 Save Logic", copyCode: "📋 Copy Submission Code",
    import: "📂 Load Logic", importSuccess: "Project loaded successfully!", importError: "Invalid PLC submission file.", cancel: "Cancel",
    studentSubTitle: "Student Submission", studentSubDesc: "Please enter your details to generate your submission file/code.",
    studentName: "Student Name", studentId: "Student ID", classSection: "Class / Section", downloadJson: "Download JSON",
    plcSystemMode: "PLC System Mode", brand_generic: "Generic Learning Mode", brand_siemens: "Siemens Training Board Mode",
    brand_mitsubishi: "Mitsubishi Quick-Connection Mode", addressingRef: "Addressing Reference", refGeneric: "Generic: I:0/0, O:0/0, M:0/0",
    refSiemens: "Siemens: I0.0, Q0.0, M0.0", refMitsubishi: "Mitsubishi: X0, Y0, M0", vendorNeutralNote: "The simulator keeps a vendor-neutral internal logic engine. The selected PLC mode changes the addressing format shown to students so that the exercises align with different PLC training hardware.",
    compatGeneric: "Generic Ladder Logic Exercise", compatSiemens: "Compatible with Siemens Training Board", compatMitsubishi: "Compatible with Mitsubishi Quick-Connection Practice",
    sfTitle: "🏭 Mini Smart Factory", sfDesc: "An advanced integrated production line combining conveyor control, filling, capping, inspection, sorting, packaging, counters, timers, and fault handling.",
    simulation: "Simulation", guidedMode: "Guided Mode", challengeMode: "Challenge Mode", hwMapMode: "Hardware Mapping Mode",
    hwMapTitle: "Wiring Preparation for Real PLC Trainers", sfIoMapTitle: "Smart Factory I/O Mapping", func: "Function",
    dispAddr: "Displayed Address", purpose: "Purpose", guidedL1: "Create start/stop latch using {0} and {1}.",
    guidedL2: "Turn ON conveyor motor ({0}) when system is running.", guidedL3: "Stop conveyor at filling station using sensor {0}.",
    guidedL4: "Activate fill pump ({0}) and fill valve ({1}) until bottle is full ({2}).", guidedL5: "Move to capping station and activate clamp/capper ({0}, {1}).",
    guidedL6: "Inspect product quality using sensor {0}.", guidedL7: "Reject bad product using diverter solenoid ({0}).",
    guidedL8: "Count accepted products on packaging conveyor ({0}).", guidedL9: "Stop the line when batch target is reached.",
    ...
    sysStatus: "System Status", target: "Target", good: "Good", tank: "Tank", reject: "Reject", fill: "Fill", qualResult: "Quality Result",
    activeOut: "Active Output", inactiveOut: "Inactive Output", faultReject: "Fault / Reject", safetyStart: "Safety and Start-Up",
    conveyorTrans: "Conveyor Transport", mixTank: "Mixing Tank", fillStation: "Filling Station", capStation: "Capping Station",
    qualInspect: "Quality Inspection", sortStation: "Sorting Station", packArea: "Packaging Area", goodCount: "Good Count",
    rejectCount: "Reject Count", batchTarget: "Batch Target", faultStatus: "Fault Status", activeStation: "Active Station",
    eStop: "Emergency Stop", rejectFull: "Reject Bin Full", tankLow: "Tank Low Level", sysReady: "System Ready", batchComplete: "Batch Complete",
    howToRunTitle: "How to Run This Simulation", studentGuideTitle: "PLC Simulator Student Guide", step1: "Step 1: Select PLC System Mode.",
    step2: "Step 2: Open Ladder Logic Editor.", step3: "Step 3: Build the required ladder logic.", step4: "Step 4: Click RUN SYSTEM.",
    step5: "Step 5: Use the Physical Panel to press Start, Stop, Reset, Emergency Stop, and Quality OK.", step6: "Step 6: Observe the process simulation.",
    step7: "Step 7: Use the Logic Debug Checklist to troubleshoot.", guideNote: "Note: For best performance, use a laptop or tablet. Phone users should use landscape mode. If the simulator does not work properly inside WeChat, open the link in Chrome, Edge, or Safari.",
    progTaskTitle: "Programming Task", runtimeActTitle: "Runtime Action", whyNotRunning: "Why Not Running?", procNotMoving: "Process is not moving because:",
    sysStoppedFault: "System stopped due to fault:", reqNowLabel: "Required Now", notActLabel: "Not Active", faultLabel: "Fault",
    okLabel: "OK", pass: "Pass", rejectBtn: "Reject", waiting: "Waiting", stopped: "Stopped", legend: "Legend", inputSens: "Input Sensor / Button",
    outputAct: "Output Actuator", intMemory: "Internal Memory", faultReason: "Fault Reason", logicDebug: "Logic Debug Checklist",
    activeStep: "Active Step", clearFault: "Clear fault and press Reset button (I:0/3).", actStart: "Press Start and create a System Run Latch (M:0/0).",
    actConv: "Turn ON the Conveyor Motor (O:0/0) to move the bottle.", actFill: "Bottle is at filling station. Stop conveyor and activate Fill Pump (O:0/1) + Fill Valve (O:0/2).",
    actFull: "Bottle is full. Move it to capping station.", actCap: "Activate Clamp Solenoid (O:0/5) and Capper Motor (O:0/6).",
    actCapDone: "Cap done. Move to inspection.", actInspect: "Check Quality OK sensor, then choose packaging or reject.",
    actReject: "Activate Diverter Solenoid (O:0/7) to reject bad product.", actBatch: "Batch target reached. Stop the line and activate buzzer (O:1/3).",
    basicPlc: "Basic PLC", intermProg: "Intermediate Programming", analogProg: "Analog Programming", openModule: "Open Module",
    learningOutcomes: "Learning Outcomes", backToModules: "← Back to Modules", comingSoon: "This application will be available in the next development stage.",
    ...
    conceptBasic1: "Digital input/output control", conceptBasic2: "Timers and counters", conceptBasic3: "Latching and basic interlocking",
    conceptBasic4: "Process simulation", conceptInt1: "Increment / Decrement", conceptInt2: "Move and Compare", conceptInt3: "Shift Register",
    conceptInt4: "Multiplication / Divide", conceptInt5: "Interlocking", conceptAna1: "Raw analog input", conceptAna2: "Scaling to engineering units",
    conceptAna3: "Analog threshold comparison", conceptAna4: "Alarm logic", conceptAna5: "Analog output simulation", prodSens: "Product Sensor",
    shiftPulse: "Shift Pulse", entrySens: "Entry Sensor", rejectDiv: "Reject Diverter", simGood: "Simulate Good", simReject: "Simulate Reject",
    guardDoor: "Guard Door", jamSensor: "Jam Sensor", interlockOk: "Interlock OK", interlockViol: "Interlock Violation", divByZero: "Divide by Zero Warning",
    totalCount: "Total Count", rejectPercent: "Reject Percentage", prodStats: "Production Statistics"
  },
  zh: {
    appTitle: "Pro PLC 模拟器", homeDesc: "基于Web的PLC梯形图逻辑和过程控制培训模拟器", inputs: "输入", outputs: "输出", memory: "内存", system: "系统",
    tabIo: "1. I/O 配置", tabLadder: "2. 梯形图编辑器", tabProcess: "🏭 3. 2D 过程工厂", runSystem: "运行系统", stopSystem: "停止系统",
    resetSim: "↺ 重置模拟", ioTagDb: "I/O 标签数据库", ioDesc: "在编程之前定义您的物理输入和输出。单击任何标签名称以重命名它。",
    type: "类型", address: "地址", tagName: "标签名称", addTag: "添加标签", behavior: "控制行为", toggleSwitch: "切换开关",
    pushButton: "按钮", autoSensor: "自动传感器", physicalPanel: "物理面板", physicalDesc: "切换输入状态并监控输出状态。",
    dataRegPanel: "数据寄存器", dataRegDesc: "监控中间数据。在停止状态下可编辑目标值。", ladderProg: "梯形图编辑器",
    editMode: "编辑模式", running: "运行中", addRung: "+ 添加逻辑行", noRungs: "未定义梯形图。单击“+ 添加逻辑行”开始。",
    selectTarget: "目标...", preset: "预设值:", parallelDown: "+ 并联分支 ↓", outputDown: "+ 并联输出 ↓", processSim: "2D 过程模拟",
    processDesc: "编写控制此工厂所需的梯形图逻辑！", bottles: "瓶子数量", conveyor: "传送带", valve: "灌装阀", motorUp: "向上电机",
    motorDn: "向下电机", fillPump: "进水泵", drainPump: "排水泵", mixer: "搅拌机", heater: "加热器", floor2: "2楼", floor1: "1楼",
    ground: "底层", call: "呼叫", on: "开", off: "关", photoEyeHelp: "光电传感器 (I:0/4) - 在左侧面板切换", prox: "接近", level: "液位",
    high: "高", low: "低", loadTemplate: "加载模板", export: "💾 保存逻辑", copyCode: "📋 复制提交代码", import: "📂 加载逻辑",
    importSuccess: "项目加载成功！", importError: "无效的PLC提交文件。", cancel: "取消", studentSubTitle: "学生作业提交",
    studentSubDesc: "请输入您的详细信息以生成提交文件/代码。", studentName: "学生姓名", studentId: "学号", classSection: "班级 / 组别",
    downloadJson: "下载 JSON", plcSystemMode: "PLC系统模式", brand_generic: "通用学习模式", brand_siemens: "西门子实训板模式",
    brand_mitsubishi: "三菱快接线模式", addressingRef: "寻址参考", refGeneric: "通用: I:0/0, O:0/0, M:0/0", refSiemens: "西门子: I0.0, Q0.0, M0.0",
    refMitsubishi: "三菱: X0, Y0, M0", vendorNeutralNote: "该模拟器保留了与供应商无关的内部逻辑引擎。选择的PLC模式仅改变向学生显示的寻址格式，以使练习与不同的PLC培训硬件对齐。",
    compatGeneric: "通用梯形图逻辑练习", compatSiemens: "兼容西门子实训板", compatMitsubishi: "兼容三菱快接线练习",
    sfTitle: "🏭 迷你智能工厂", sfDesc: "一个高级综合生产线，结合输送带控制、灌装、封盖、检测、分拣、包装、计数器、定时器和故障处理。",
    simulation: "模拟画面", guidedMode: "引导模式", challengeMode: "挑战模式", hwMapMode: "硬件映射模式", hwMapTitle: "真实PLC实训设备的接线准备",
    sfIoMapTitle: "智能工厂 I/O 映射", func: "功能", dispAddr: "显示地址", purpose: "用途", guidedL1: "使用 {0} 和 {1} 创建启动/停止锁存器。",
    guidedL2: "当系统运行时，打开输送带电机 ({0})。", guidedL3: "使用传感器 {0} 在灌装站停止输送带。", guidedL4: "激活灌装泵 ({0}) 和灌装阀 ({1}) 直到瓶子灌满 ({2})。",
    guidedL5: "移动到封盖站并激活夹具/封盖机 ({0}, {1})。", guidedL6: "使用传感器 {0} 检查产品质量。", guidedL7: "使用分流电磁阀 ({0}) 剔除不良品。",
    guidedL8: "在包装输送带上对合格产品进行计数 ({0})。", guidedL9: "达到批次目标时停止生产线。", guidedL10: "添加急停 ({0})、废料箱满 ({1}) 和水箱低液位 ({2}) 故障处理。",
    challengeDesc: "“设计一个梯形图程序，自动完成10个瓶子的灌装、封盖、检测、分拣和包装。剔除不良品，并在急停、水箱低液位或废料箱满时停止系统。”",
    sysStatus: "系统状态", target: "目标", good: "合格", tank: "水箱", reject: "剔除数量", fill: "灌装", qualResult: "质量结果",
    activeOut: "输出激活", inactiveOut: "输出未激活", faultReject: "故障 / 剔除", safetyStart: "安全与启动", conveyorTrans: "输送带运输",
    mixTank: "混合罐", fillStation: "灌装站", capStation: "封盖站", qualInspect: "质量检测", sortStation: "分拣站", packArea: "包装区",
    goodCount: "合格数量", rejectCount: "次品数量", batchTarget: "批次目标", faultStatus: "故障状态", activeStation: "当前工站",
    eStop: "紧急停止", rejectFull: "废品箱满", tankLow: "水箱低液位", sysReady: "系统就绪", batchComplete: "批次完成",
    howToRunTitle: "如何运行此模拟", studentGuideTitle: "PLC 模拟器学生指南", step1: "步骤1：选择PLC系统模式。", step2: "步骤2：打开梯形图编辑器。",
    step3: "步骤3：构建所需的梯形图逻辑。", step4: "步骤4：点击运行系统 (RUN SYSTEM)。", step5: "步骤5：使用物理面板按下启动、停止、复位、急停和质量合格按钮。",
    step6: "步骤6：观察过程模拟。", step7: "步骤7：使用逻辑调试清单进行故障排除。", guideNote: "注意：为了获得最佳性能，请使用笔记本电脑或平板电脑。手机用户应使用横屏模式。如果模拟器在微信内无法正常运行，请在Chrome、Edge或Safari浏览器中打开链接。",
    progTaskTitle: "编程任务", runtimeActTitle: "运行操作", whyNotRunning: "为什么没有运行？", procNotMoving: "过程未运行，因为：",
    sysStoppedFault: "系统因故障停止：", reqNowLabel: "当前需要", notActLabel: "未激活", faultLabel: "故障", okLabel: "正常", pass: "合格",
    rejectBtn: "剔除", waiting: "等待", stopped: "已停止", legend: "图例", inputSens: "输入传感器/按钮", outputAct: "输出执行器",
    intMemory: "内部内存", faultReason: "故障原因", logicDebug: "逻辑调试清单", activeStep: "活动步骤", clearFault: "清除故障并按下复位按钮 (I:0/3)。",
    actStart: "按下启动并建立系统运行锁存 (M:0/0)。", actConv: "打开输送带电机 (O:0/0) 移动瓶子。", actFill: "瓶子在灌装站。停止输送带并激活灌装泵 (O:0/1) 和灌装阀 (O:0/2)。",
    actFull: "瓶子已满。将其移动到封盖站。", actCap: "激活夹紧电磁阀 (O:0/5) 和封盖电机 (O:0/6)。", actCapDone: "封盖完成。移动到检测站。",
    actInspect: "检查质量合格传感器，然后选择包装或剔除。", actReject: "激活分流电磁阀 (O:0/7) 剔除不良品。", actBatch: "达到批次目标。停止生产线并激活蜂鸣器 (O:1/3)。",
    basicPlc: "基础 PLC", intermProg: "中级编程", analogProg: "模拟量编程", openModule: "打开模块", learningOutcomes: "学习成果",
    backToModules: "← 返回模块列表", comingSoon: "此应用将在下一开发阶段开放。", basicPlcDesc: "通过数字输入、输出、定时器、计数器、锁存、基础联锁和动画过程模拟学习基础 PLC 梯形图逻辑。",
    intermProgDesc: "通过批次计数、移位寄存器分拣、算术计算、数据传送、比较和联锁等过程应用练习中级 PLC 指令。", analogProgDesc: "通过实际模拟量过程应用学习模拟量输入缩放、工程单位、阈值比较、报警逻辑和模拟量输出控制。",
    conceptBasic1: "数字输入/输出控制", conceptBasic2: "定时器和计数器", conceptBasic3: "锁存和基础联锁", conceptBasic4: "过程模拟",
    conceptInt1: "递增 / 递减", conceptInt2: "传送与比较", conceptInt3: "移位寄存器", conceptInt4: "乘法 / 除法", conceptInt5: "联锁",
    conceptAna1: "原始模拟量输入", conceptAna2: "转换为工程单位", conceptAna3: "模拟量阈值比较", conceptAna4: "报警逻辑", conceptAna5: "模拟量输出模拟",
    prodSens: "产品传感器", shiftPulse: "移位脉冲", entrySens: "入口传感器", rejectDiv: "剔除分流器", simGood: "模拟合格品", simReject: "模拟不良品",
    guardDoor: "安全门", jamSensor: "卡料传感器", interlockOk: "联锁正常", interlockViol: "联锁违规", divByZero: "除零警告", totalCount: "总计数",
    rejectPercent: "不良率", prodStats: "生产统计"
  }
};

const formatAddress = (addr, brand) => {
  if (!addr) return addr;
  const m = addr.match(/^([IOM]):(\d+)\/(\d+)$/);
  if (!m) return addr; 
  if (brand === 'siemens') return `${m[1]==='I'?'I':m[1]==='O'?'Q':'M'}${m[2]}.${m[3]}`;
  if (brand === 'mitsubishi') return `${m[1]==='I'?'X':m[1]==='O'?'Y':'M'}${m[2]==='0'?m[3]:m[2]+m[3]}`;
  return addr;
};
...
const INTERMEDIATE_MODULES = [
  { key: 'batchCount', name_en: 'Batch Counter & Production Target System', name_zh: '批次计数与生产目标系统', desc_en: 'Learn product counting, remaining quantity, target comparison, and batch complete logic.', desc_zh: '学习产品计数、剩余数量、目标比较和批次完成逻辑。', concepts_en: ['Increment / Decrement', 'Move', 'Compare', 'Batch target logic'], concepts_zh: ['递增 / 递减', '传送', '比较', '批次目标逻辑'] },
  { key: 'shiftReg', name_en: 'Shift Register Sorting Conveyor', name_zh: '移位寄存器分拣输送系统', desc_en: 'Learn how shift registers track product status along a conveyor before sorting.', desc_zh: '学习移位寄存器如何在输送线上跟踪产品状态并进行分拣。', concepts_en: ['Shift Register', 'Move', 'Compare', 'Product tracking', 'Sorting logic'], concepts_zh: ['移位寄存器', '传送', '比较', '产品跟踪', '分拣逻辑'] },
  { key: 'interlock', name_en: 'Interlocking & Production Statistics System', name_zh: '联锁与生产统计系统', desc_en: 'Learn arithmetic calculation, reject percentage, production statistics, and safety interlocking.', desc_zh: '学习算术计算、不良率、生产统计和安全联锁的过程应用。', concepts_en: ['Multiplication / Divide', 'Compare', 'Interlocking', 'Fault prevention', 'Production statistics'], concepts_zh: ['乘法 / 除法', '比较', '联锁', '故障预防', '生产统计'] }
];

const ANALOG_MODULES = [
  { key: 'tankLevel', name_en: 'Analog Tank Level Control', name_zh: '模拟量水箱液位控制', desc_en: 'Learn analog level scaling, low/high threshold detection, pump control, valve control, and alarm logic.', desc_zh: '学习模拟量液位缩放、高低阈值检测、水泵控制、阀门控制和报警逻辑。', concepts_en: ['Analog input scaling', 'Level percentage', 'Threshold comparison', 'Pump and valve control', 'Alarm logic'], concepts_zh: ['模拟量输入缩放', '液位百分比', '阈值比较', '水泵和阀门控制', '报警逻辑'] },
  { key: 'tempFan', name_en: 'Temperature & Fan Speed Control', name_zh: '温度与风扇速度控制', desc_en: 'Learn temperature scaling, setpoint comparison, heater control, cooling fan control, and analog output percentage.', desc_zh: '学习温度缩放、设定值比较、加热器控制、冷却风扇控制和模拟量输出百分比。', concepts_en: ['Temperature scaling', 'Setpoint comparison', 'Heater control', 'Cooling fan control', 'Analog output simulation'], concepts_zh: ['温度缩放', '设定值比较', '加热器控制', '冷却风扇控制', '模拟量输出模拟'] },
  { key: 'pressureAlarm', name_en: 'Pressure Monitoring & Alarm System', name_zh: '压力监测与报警系统', desc_en: 'Learn pressure scaling, safe threshold monitoring, relief valve control, and alarm interlocking.', desc_zh: '学习压力缩放、安全阈值监测、泄压阀控制和报警联锁。', concepts_en: ['Pressure scaling', 'Threshold comparison', 'Alarm logic', 'Relief valve control'], concepts_zh: ['压力缩放', '阈值比较', '报警逻辑', '泄压阀控制'] }
];

const PLANT_TEMPLATES = {
  sandbox: { category: 'basic', name_en: "🛠️ Sandbox (Beginner)", name_zh: "🛠️ 沙盒 (初学者)", desc_en: "A blank canvas to learn basic logic gates.", desc_zh: "一个空白画布，用于学习基本逻辑门。", ioMap: [ { id: 'io1', type: 'input', address: 'I:0/0', tag_en: 'Switch_A', tag_zh: '开关_A', mode: 'toggle' }, { id: 'io2', type: 'input', address: 'I:0/1', tag_en: 'Switch_B', tag_zh: '开关_B', mode: 'toggle' }, { id: 'io3', type: 'input', address: 'I:0/2', tag_en: 'Push_Button', tag_zh: '按钮', mode: 'momentary' }, { id: 'out1', type: 'output', address: 'O:0/0', tag_en: 'Green_LED', tag_zh: '绿灯' }, { id: 'out2', type: 'output', address: 'O:0/1', tag_en: 'Yellow_LED', tag_zh: '黄灯' }, { id: 'out3', type: 'output', address: 'O:0/2', tag_en: 'Red_LED', tag_zh: '红灯' } ], rungs: BLANK_RUNG },
  bottle: { category: 'basic', name_en: "🍾 Bottle Filling Line", name_zh: "🍾 灌装生产线", desc_en: "Control a conveyor belt and a fill valve using proximity and level sensors.", desc_zh: "使用接近和液位传感器控制传送带和灌装阀。", ioMap: [ { id: 'io1', type: 'input', address: 'I:0/0', tag_en: 'Start_Button', tag_zh: '启动按钮', mode: 'momentary' }, { id: 'io2', type: 'input', address: 'I:0/1', tag_en: 'Stop_Button', tag_zh: '停止按钮', mode: 'momentary' }, { id: 'io3', type: 'input', address: 'I:0/2', tag_en: 'Bottle_Present_Sensor', tag_zh: '瓶子到位传感器', mode: 'auto' }, { id: 'io4', type: 'input', address: 'I:0/3', tag_en: 'Bottle_Full_Sensor', tag_zh: '瓶满传感器', mode: 'auto' }, { id: 'out1', type: 'output', address: 'O:0/0', tag_en: 'Conveyor_Motor', tag_zh: '传送带电机' }, { id: 'out2', type: 'output', address: 'O:0/1', tag_en: 'Fill_Valve', tag_zh: '灌装阀' } ], rungs: BLANK_RUNG },
  garage: { category: 'basic', name_en: "🚪 Garage Door", name_zh: "🚪 车库门控制", desc_en: "Safely open and close a door using limit switches and interlocks.", desc_zh: "使用限位开关和联锁装置安全地打开和关闭车库门。", ioMap: [ { id: 'io1', type: 'input', address: 'I:0/0', tag_en: 'Open_Button', tag_zh: '开门按钮', mode: 'momentary' }, { id: 'io2', type: 'input', address: 'I:0/1', tag_en: 'Close_Button', tag_zh: '关门按钮', mode: 'momentary' }, { id: 'io3', type: 'input', address: 'I:0/2', tag_en: 'Upper_Limit', tag_zh: '上限位', mode: 'auto' }, { id: 'io4', type: 'input', address: 'I:0/3', tag_en: 'Lower_Limit', tag_zh: '下限位', mode: 'auto' }, { id: 'io5', type: 'input', address: 'I:0/4', tag_en: 'Photo_Eye_Blocked', tag_zh: '光电被遮挡', mode: 'toggle' }, { id: 'out1', type: 'output', address: 'O:0/0', tag_en: 'Motor_Up', tag_zh: '电机_上' }, { id: 'out2', type: 'output', address: 'O:0/1', tag_en: 'Motor_Down', tag_zh: '电机_下' } ], rungs: BLANK_RUNG },
  tank: { category: 'basic', name_en: "🧪 Batch Mixing Tank", name_zh: "🧪 批量混合罐", desc_en: "Fill a tank, mix and heat the contents, then drain it using level sensors.", desc_zh: "填充水箱，混合并加热内容物，然后使用液位传感器将其排空。", ioMap: [ { id: 'io1', type: 'input', address: 'I:0/0', tag_en: 'Start_Fill', tag_zh: '开始注水', mode: 'momentary' }, { id: 'io2', type: 'input', address: 'I:0/1', tag_en: 'Start_Drain', tag_zh: '开始排水', mode: 'momentary' }, { id: 'io3', type: 'input', address: 'I:0/2', tag_en: 'Low_Sensor', tag_zh: '低液位传感器', mode: 'auto' }, { id: 'io4', type: 'input', address: 'I:0/3', tag_en: 'High_Sensor', tag_zh: '高液位传感器', mode: 'auto' }, { id: 'out1', type: 'output', address: 'O:0/0', tag_en: 'Fill_Pump', tag_zh: '进水泵' }, { id: 'out2', type: 'output', address: 'O:0/1', tag_en: 'Drain_Pump', tag_zh: '排水泵' }, { id: 'out3', type: 'output', address: 'O:0/2', tag_en: 'Mixer', tag_zh: '搅拌机' }, { id: 'out4', type: 'output', address: 'O:0/3', tag_en: 'Heater', tag_zh: '加热器' } ], rungs: BLANK_RUNG },
  traffic: { category: 'basic', name_en: "🚦 Traffic Intersection", name_zh: "🚦 交通路口", desc_en: "Use cascaded timers to sequence N/S and E/W traffic lights perfectly.", desc_zh: "使用级联定时器完美控制南北和东西交通信号灯的顺序。", ioMap: [ { id: 'io1', type: 'input', address: 'I:0/0', tag_en: 'Enable_System', tag_zh: '启用系统', mode: 'toggle' }, { id: 'out1', type: 'output', address: 'O:0/0', tag_en: 'NS_Green', tag_zh: '南北_绿灯' }, { id: 'out2', type: 'output', address: 'O:0/1', tag_en: 'NS_Yellow', tag_zh: '南北_黄灯' }, { id: 'out3', type: 'output', address: 'O:0/2', tag_en: 'NS_Red', tag_zh: '南北_红灯' }, { id: 'out4', type: 'output', address: 'O:0/3', tag_en: 'EW_Green', tag_zh: '东西_绿灯' }, { id: 'out5', type: 'output', address: 'O:0/4', tag_en: 'EW_Yellow', tag_zh: '东西_黄灯' }, { id: 'out6', type: 'output', address: 'O:0/5', tag_en: 'EW_Red', tag_zh: '东西_红灯' }, { id: 'mem1', type: 'memory', address: 'M:0/0', tag_en: 'Timer_NS_G', tag_zh: '定时器_南北绿' }, { id: 'mem2', type: 'memory', address: 'M:0/1', tag_en: 'Timer_NS_Y', tag_zh: '定时器_南北黄' }, { id: 'mem3', type: 'memory', address: 'M:0/2', tag_en: 'Timer_EW_G', tag_zh: '定时器_东西绿' }, { id: 'mem4', type: 'memory', address: 'M:0/3', tag_en: 'Timer_EW_Y', tag_zh: '定时器_东西黄' } ], rungs: BLANK_RUNG },
  elevator: { category: 'basic', name_en: "🛗 3-Floor Elevator", name_zh: "🛗 3层电梯", desc_en: "Build logic to latch floor calls and control the UP/DOWN motors.", desc_zh: "构建逻辑来锁存楼层呼叫，并控制升降电机。", ioMap: [ { id: 'io1', type: 'input', address: 'I:0/0', tag_en: 'Call_Ground', tag_zh: '呼叫_底层', mode: 'momentary' }, { id: 'io2', type: 'input', address: 'I:0/1', tag_en: 'Call_Floor_1', tag_zh: '呼叫_1楼', mode: 'momentary' }, { id: 'io3', type: 'input', address: 'I:0/2', tag_en: 'Call_Floor_2', tag_zh: '呼叫_2楼', mode: 'momentary' }, { id: 'io4', type: 'input', address: 'I:0/3', tag_en: 'Sensor_Ground', tag_zh: '传感器_底层', mode: 'auto' }, { id: 'io5', type: 'input', address: 'I:0/4', tag_en: 'Sensor_Floor_1', tag_zh: '传感器_1楼', mode: 'auto' }, { id: 'io6', type: 'input', address: 'I:0/5', tag_en: 'Sensor_Floor_2', tag_zh: '传感器_2楼', mode: 'auto' }, { id: 'out1', type: 'output', address: 'O:0/0', tag_en: 'Motor_Up', tag_zh: '电机_上' }, { id: 'out2', type: 'output', address: 'O:0/1', tag_en: 'Motor_Down', tag_zh: '电机_下' }, { id: 'mem1', type: 'memory', address: 'M:0/0', tag_en: 'Req_G', tag_zh: '请求_底层' }, { id: 'mem2', type: 'memory', address: 'M:0/1', tag_en: 'Req_1', tag_zh: '请求_1楼' }, { id: 'mem3', type: 'memory', address: 'M:0/2', tag_en: 'Req_2', tag_zh: '请求_2楼' }, { id: 'mem4', type: 'memory', address: 'M:0/3', tag_en: 'Move_Up', tag_zh: '上升_锁定' }, { id: 'mem5', type: 'memory', address: 'M:0/4', tag_en: 'Move_Down', tag_zh: '下降_锁定' } ], rungs: BLANK_RUNG },
  smartFactory: { category: 'basic', name_en: "🏭 Mini Smart Factory", name_zh: "🏭 迷你智能工厂", desc_en: "An advanced integrated production line combining conveyor control, filling, capping, inspection, sorting, packaging, counters, timers, and fault handling.", desc_zh: "一个高级综合生产线，结合输送带控制、灌装、封盖、检测、分拣、包装、计数器、定时器和故障处理。", ioMap: [ { id: 'sf_i1', type: 'input', address: 'I:0/0', tag_en: 'Start_Button', tag_zh: '启动按钮', mode: 'momentary', purpose: 'Start system' }, { id: 'sf_i2', type: 'input', address: 'I:0/1', tag_en: 'Stop_Button', tag_zh: '停止按钮', mode: 'momentary', purpose: 'Stop system' }, { id: 'sf_i3', type: 'input', address: 'I:0/2', tag_en: 'Emergency_Stop', tag_zh: '紧急停止', mode: 'toggle', purpose: 'Emergency fault' }, { id: 'sf_i4', type: 'input', address: 'I:0/3', tag_en: 'Reset_Button', tag_zh: '复位按钮', mode: 'momentary', purpose: 'Reset faults' }, { id: 'sf_i5', type: 'input', address: 'I:0/4', tag_en: 'Bottle_Entry_Sensor', tag_zh: '入料传感器', mode: 'auto', purpose: 'Detect entry' }, { id: 'sf_i6', type: 'input', address: 'I:0/5', tag_en: 'Fill_Position_Sensor', tag_zh: '灌装位传感器', mode: 'auto', purpose: 'Detect fill pos' }, { id: 'sf_i7', type: 'input', address: 'I:0/6', tag_en: 'Bottle_Full_Sensor', tag_zh: '瓶满传感器', mode: 'auto', purpose: 'Detect full' }, { id: 'sf_i8', type: 'input', address: 'I:0/7', tag_en: 'Cap_Position_Sensor', tag_zh: '封盖位传感器', mode: 'auto', purpose: 'Detect cap pos' }, { id: 'sf_i9', type: 'input', address: 'I:1/0', tag_en: 'Cap_Done_Sensor', tag_zh: '封盖完成传感器', mode: 'auto', purpose: 'Detect cap done' }, { id: 'sf_i10', type: 'input', address: 'I:1/1', tag_en: 'Quality_OK_Sensor', tag_zh: '质量合格传感器', mode: 'toggle', purpose: 'Quality status' }, { id: 'sf_i11', type: 'input', address: 'I:1/2', tag_en: 'Reject_Bin_Full', tag_zh: '废料箱满', mode: 'toggle', purpose: 'Bin full fault' }, { id: 'sf_i12', type: 'input', address: 'I:1/3', tag_en: 'Tank_Low_Level', tag_zh: '储罐低液位', mode: 'auto', purpose: 'Tank low fault' }, { id: 'sf_o1', type: 'output', address: 'O:0/0', tag_en: 'Conveyor_Motor', tag_zh: '输送带电机', purpose: 'Move bottles' }, { id: 'sf_o2', type: 'output', address: 'O:0/1', tag_en: 'Fill_Pump', tag_zh: '灌装泵', purpose: 'Pump liquid' }, { id: 'sf_o3', type: 'output', address: 'O:0/2', tag_en: 'Fill_Valve', tag_zh: '灌装阀', purpose: 'Open valve' }, { id: 'sf_o4', type: 'output', address: 'O:0/3', tag_en: 'Mixer_Motor', tag_zh: '搅拌电机', purpose: 'Mix tank' }, { id: 'sf_o5', type: 'output', address: 'O:0/4', tag_en: 'Heater', tag_zh: '加热器', purpose: 'Heat tank' }, { id: 'sf_o6', type: 'output', address: 'O:0/5', tag_en: 'Clamp_Solenoid', tag_zh: '夹紧电磁阀', purpose: 'Clamp bottle' }, { id: 'sf_o7', type: 'output', address: 'O:0/6', tag_en: 'Capper_Motor', tag_zh: '封盖电机', purpose: 'Cap bottle' }, { id: 'sf_o8', type: 'output', address: 'O:0/7', tag_en: 'Diverter_Solenoid', tag_zh: '分流电磁阀', purpose: 'Reject bottle' }, { id: 'sf_o9', type: 'output', address: 'O:1/0', tag_en: 'Packaging_Conveyor', tag_zh: '包装线输送带', purpose: 'Move to pkg' }, { id: 'sf_o10', type: 'output', address: 'O:1/1', tag_en: 'Run_Lamp', tag_zh: '运行指示灯', purpose: 'System running' }, { id: 'sf_o11', type: 'output', address: 'O:1/2', tag_en: 'Fault_Lamp', tag_zh: '故障指示灯', purpose: 'System fault' }, { id: 'sf_o12', type: 'output', address: 'O:1/3', tag_en: 'Buzzer', tag_zh: '蜂鸣器', purpose: 'Alarm buzzer' }, { id: 'sf_m1', type: 'memory', address: 'M:0/0', tag_en: 'System_Run_Latch', tag_zh: '系统运行锁存', purpose: 'Maintain run state' }, { id: 'sf_m2', type: 'memory', address: 'M:0/1', tag_en: 'Filling_Step', tag_zh: '灌装步骤', purpose: 'Step memory' }, { id: 'sf_m3', type: 'memory', address: 'M:0/2', tag_en: 'Capping_Step', tag_zh: '封盖步骤', purpose: 'Step memory' }, { id: 'sf_m4', type: 'memory', address: 'M:0/3', tag_en: 'Inspection_Step', tag_zh: '检测步骤', purpose: 'Step memory' }, { id: 'sf_m5', type: 'memory', address: 'M:0/4', tag_en: 'Reject_Step', tag_zh: '剔除步骤', purpose: 'Step memory' }, { id: 'sf_m6', type: 'memory', address: 'M:0/5', tag_en: 'Batch_Complete', tag_zh: '批次完成', purpose: 'Batch target met' }, { id: 'sf_m7', type: 'memory', address: 'M:0/6', tag_en: 'Fault_Latch', tag_zh: '故障锁存', purpose: 'Maintain fault' } ], rungs: BLANK_RUNG },
  batchCount: { category: 'intermediate', name_en: 'Batch Counter & Target System', name_zh: '批次计数与生产目标系统', desc_en: 'Learn product counting, target comparison, and batch complete logic.', desc_zh: '学习产品计数、目标比较和批次完成逻辑。', ioMap: [ { id: 'bc_i1', type: 'input', address: 'I:0/0', tag_en: 'Start_Button', tag_zh: '启动按钮', mode: 'momentary' }, { id: 'bc_i2', type: 'input', address: 'I:0/1', tag_en: 'Stop_Button', tag_zh: '停止按钮', mode: 'momentary' }, { id: 'bc_i3', type: 'input', address: 'I:0/2', tag_en: 'Product_Sensor', tag_zh: '产品传感器', mode: 'auto' }, { id: 'bc_i4', type: 'input', address: 'I:0/3', tag_en: 'Reset_Button', tag_zh: '复位按钮', mode: 'momentary' }, { id: 'bc_o1', type: 'output', address: 'O:0/0', tag_en: 'Conveyor_Motor', tag_zh: '输送带电机' }, { id: 'bc_o2', type: 'output', address: 'O:0/1', tag_en: 'Batch_Complete_Lamp', tag_zh: '批次完成指示灯' }, { id: 'bc_m1', type: 'memory', address: 'M:0/0', tag_en: 'System_Run_Latch', tag_zh: '系统运行锁存' } ], rungs: BLANK_RUNG },
  shiftReg: { category: 'intermediate', name_en: 'Shift Register Sorting Conveyor', name_zh: '移位寄存器分拣输送系统', desc_en: 'Learn how shift registers track product status along a conveyor.', desc_zh: '学习移位寄存器如何在输送线上跟踪产品状态。', ioMap: [ { id: 'sr_i1', type: 'input', address: 'I:0/0', tag_en: 'Start_Button', tag_zh: '启动按钮', mode: 'momentary' }, { id: 'sr_i2', type: 'input', address: 'I:0/1', tag_en: 'Stop_Button', tag_zh: '停止按钮', mode: 'momentary' }, { id: 'sr_i3', type: 'input', address: 'I:0/2', tag_en: 'Entry_Sensor', tag_zh: '入口传感器', mode: 'auto' }, { id: 'sr_i4', type: 'input', address: 'I:0/3', tag_en: 'Quality_OK_Sensor', tag_zh: '质量合格传感器', mode: 'toggle' }, { id: 'sr_i5', type: 'input', address: 'I:0/4', tag_en: 'Shift_Pulse_Sensor', tag_zh: '移位脉冲传感器', mode: 'auto' }, { id: 'sr_o1', type: 'output', address: 'O:0/0', tag_en: 'Conveyor_Motor', tag_zh: '输送带电机' }, { id: 'sr_o2', type: 'output', address: 'O:0/1', tag_en: 'Reject_Diverter', tag_zh: '剔除分流器' }, { id: 'sr_m1', type: 'memory', address: 'M:0/0', tag_en: 'System_Run_Latch', tag_zh: '系统运行锁存' } ], rungs: BLANK_RUNG },
  interlock: { category: 'intermediate', name_en: 'Interlocking & Prod Statistics', name_zh: '联锁与生产统计系统', desc_en: 'Learn arithmetic calculation, reject percentage, and safety interlocking.', desc_zh: '学习算术计算、不良率和安全联锁的过程应用。', ioMap: [ { id: 'il_i1', type: 'input', address: 'I:0/0', tag_en: 'Start_Button', tag_zh: '启动按钮', mode: 'momentary' }, { id: 'il_i2', type: 'input', address: 'I:0/1', tag_en: 'Stop_Button', tag_zh: '停止按钮', mode: 'momentary' }, { id: 'il_i3', type: 'input', address: 'I:0/2', tag_en: 'Guard_Door_Open', tag_zh: '安全门打开', mode: 'toggle' }, { id: 'il_i4', type: 'input', address: 'I:0/3', tag_en: 'Jam_Sensor', tag_zh: '卡料传感器', mode: 'toggle' }, { id: 'il_i5', type: 'input', address: 'I:0/5', tag_en: 'Simulate_Good_Product', tag_zh: '模拟合格产品', mode: 'momentary' }, { id: 'il_i6', type: 'input', address: 'I:0/6', tag_en: 'Simulate_Reject_Product', tag_zh: '模拟不良产品', mode: 'momentary' }, { id: 'il_o1', type: 'output', address: 'O:0/1', tag_en: 'Interlock_OK_Lamp', tag_zh: '联锁正常指示灯' }, { id: 'il_o2', type: 'output', address: 'O:0/2', tag_en: 'Interlock_Violation_Lamp', tag_zh: '联锁违规指示灯' }, { id: 'il_m1', type: 'memory', address: 'M:0/0', tag_en: 'System_Run_Latch', tag_zh: '系统运行锁存' } ], rungs: BLANK_RUNG },
  tankLevel: { category: 'analog', name_en: 'Analog Tank Level Control', name_zh: '模拟量水箱液位控制', desc_en: 'Learn analog level scaling, low/high threshold detection, pump control, valve control, and alarm logic.', desc_zh: '学习模拟量液位缩放、高低阈值检测、水泵控制、阀门控制和报警逻辑。', ioMap: [ { id: 'al_i1', type: 'input', address: 'I:0/0', tag_en: 'Start_Button', tag_zh: '启动按钮', mode: 'momentary' }, { id: 'al_i2', type: 'input', address: 'I:0/1', tag_en: 'Stop_Button', tag_zh: '停止按钮', mode: 'momentary' }, { id: 'al_i4', type: 'input', address: 'I:0/3', tag_en: 'Manual_Drain_Enable', tag_zh: '手动排水使能', mode: 'toggle' }, { id: 'al_o1', type: 'output', address: 'O:0/0', tag_en: 'Inlet_Pump', tag_zh: '进水泵' }, { id: 'al_o2', type: 'output', address: 'O:0/1', tag_en: 'Drain_Valve', tag_zh: '排水阀' }, { id: 'al_o3', type: 'output', address: 'O:0/2', tag_en: 'Low_Level_Alarm', tag_zh: '低液位报警' }, { id: 'al_o4', type: 'output', address: 'O:0/3', tag_en: 'High_Level_Alarm', tag_zh: '高液位报警' }, { id: 'al_m1', type: 'memory', address: 'M:0/0', tag_en: 'System_Run_Latch', tag_zh: '系统运行锁存' } ], rungs: BLANK_RUNG },
  tempFan: { category: 'analog', name_en: 'Temperature & Fan Speed Control', name_zh: '温度与风扇速度控制', desc_en: 'Learn temperature scaling, setpoint comparison, heater control, cooling fan control, and analog output percentage.', desc_zh: '学习温度缩放、设定值比较、加热器控制、冷却风扇控制和模拟量输出百分比。', ioMap: [ { id: 'tf_i1', type: 'input', address: 'I:0/0', tag_en: 'Start_Button', tag_zh: '启动按钮', mode: 'momentary' }, { id: 'tf_i2', type: 'input', address: 'I:0/1', tag_en: 'Stop_Button', tag_zh: '停止按钮', mode: 'momentary' }, { id: 'tf_i4', type: 'input', address: 'I:0/3', tag_en: 'Door_Open', tag_zh: '门打开', mode: 'toggle' }, { id: 'tf_o1', type: 'output', address: 'O:0/0', tag_en: 'Heater', tag_zh: '加热器' }, { id: 'tf_o2', type: 'output', address: 'O:0/1', tag_en: 'Cooling_Fan', tag_zh: '冷却风扇' }, { id: 'tf_o3', type: 'output', address: 'O:0/2', tag_en: 'High_Temp_Alarm', tag_zh: '高温报警' }, { id: 'tf_m1', type: 'memory', address: 'M:0/0', tag_en: 'System_Run_Latch', tag_zh: '系统运行锁存' } ], rungs: BLANK_RUNG },
  pressureAlarm: { category: 'analog', name_en: 'Pressure Monitoring & Alarm System', name_zh: '压力监测与报警系统', desc_en: 'Learn pressure scaling, safe threshold monitoring, relief valve control, and alarm interlocking.', desc_zh: '学习压力缩放、安全阈值监测、泄压阀控制和报警联锁。', ioMap: [ { id: 'pa_i1', type: 'input', address: 'I:0/0', tag_en: 'Start_Button', tag_zh: '启动按钮', mode: 'momentary' }, { id: 'pa_i2', type: 'input', address: 'I:0/1', tag_en: 'Stop_Button', tag_zh: '停止按钮', mode: 'momentary' }, { id: 'pa_i3', type: 'input', address: 'I:0/2', tag_en: 'Reset_Alarm_Button', tag_zh: '复位报警按钮', mode: 'momentary' }, { id: 'pa_i4', type: 'input', address: 'I:0/3', tag_en: 'Manual_Relief_Button', tag_zh: '手动泄压按钮', mode: 'momentary' }, { id: 'pa_o1', type: 'output', address: 'O:0/0', tag_en: 'Compressor', tag_zh: '压缩机' }, { id: 'pa_o2', type: 'output', address: 'O:0/1', tag_en: 'Relief_Valve', tag_zh: '泄压阀' }, { id: 'pa_o3', type: 'output', address: 'O:0/2', tag_en: 'Warning_Lamp', tag_zh: '警告指示灯' }, { id: 'pa_o4', type: 'output', address: 'O:0/3', tag_en: 'Critical_Alarm_Lamp', tag_zh: '严重报警指示灯' }, { id: 'pa_m1', type: 'memory', address: 'M:0/0', tag_en: 'System_Run_Latch', tag_zh: '系统运行锁存' }, { id: 'pa_m2', type: 'memory', address: 'M:0/2', tag_en: 'Critical_Fault_Latch', tag_zh: '严重故障锁存' } ], rungs: BLANK_RUNG }
};
...
const App = () => {
  ...
  const [plantState, setPlantState] = useState({
    ...
    tankLevel: { rawLevel: 0 },
    tempFan: { rawTemp: 1024 },
    pressureAlarm: { rawPress: 0 }
  });
  ...
  const loadTemplate = (plantId) => {
    ...
    const localizedIoMap = PLANT_TEMPLATES[plantId].ioMap.map(io => ({ id: io.id, type: io.type, address: io.address, mode: io.mode || 'toggle', purpose: io.purpose || '', tag_en: io.tag_en, tag_zh: io.tag_zh, customTag: '' }));
    ...
    let initRegs = { D0: 0, D1: 0, D2: 10, D3: 0, D4: 0, D5: 0, D6: 0, D7: 0 };
    if (plantId === 'tankLevel') initRegs = { D0: 0, D1: 0, D2: 60, D3: 85, D4: 25, D5: 0, D6: 0, D7: 0 };
    if (plantId === 'tempFan') initRegs = { D0: 1024, D1: 25, D2: 30, D3: 45, D4: 0, D5: 0, D6: 0, D7: 0 };
    if (plantId === 'pressureAlarm') initRegs = { D0: 0, D1: 0, D2: 5, D3: 7, D4: 8, D5: 0, D6: 0, D7: 0 };
    setDataRegisters(initRegs);
    setShiftRegisters({ SR0: [0, 0, 0, 0, 0, 0, 0, 0] });
    
    setPlantState({ bottle: { pos: -200, fill: 0, count: 0 }, garage: { pos: 0 }, tank: { level: 0 }, elevator: { pos: 0 }, smartFactory: { bottlePos: -50, bottleFill: 0, tankLevel: 100, capProgress: 0, currentBottleQuality: true, goodCount: 0, rejectCount: 0, batchTarget: 10, rejected: false, packaged: false, activeStation: 'Start' }, batchCount: { boxPos: 0 }, shiftReg: { animOffset: 0 }, tankLevel: { rawLevel: 0 }, tempFan: { rawTemp: 1024 }, pressureAlarm: { rawPress: 0 } });
  ...
  const getRegLabel = (reg) => {
    if (selectedPlant === 'tankLevel') { const lbls = {D0: 'Raw Level', D1: 'Level %', D2: 'Target %', D3: 'High Lim', D4: 'Low Lim', D5: 'Valve %', D6: 'Temp', D7: 'Fault'}; return lbls[reg]; }
    if (selectedPlant === 'tempFan') { const lbls = {D0: 'Raw Temp', D1: 'Temp °C', D2: 'Setpoint °C', D3: 'High Lim', D4: 'Error', D5: 'Fan Spd %', D6: 'Temp', D7: 'Fault'}; return lbls[reg]; }
    if (selectedPlant === 'pressureAlarm') { const lbls = {D0: 'Raw Press', D1: 'Press bar', D2: 'Target', D3: 'Warn Lim', D4: 'Crit Lim', D5: 'Relief %', D6: 'Temp', D7: 'Fault'}; return lbls[reg]; }
    const def = {D0: 'D0', D1: 'D1', D2: 'D2', D3: 'D3', D4: 'D4', D5: 'D5', D6: 'D6', D7: 'D7'}; return def[reg];
  };

  const goBackToCategory = () => {
    setIsRunning(false); setActiveTab('home');
    const cat = PLANT_TEMPLATES[selectedPlant]?.category || selectedCategory;
    setSelectedCategory(cat); setSelectedPlant(null);
  };
  ...
  const resetSimulation = () => {
    ...
    setPlantState({ bottle: { pos: -200, fill: 0, count: 0 }, garage: { pos: 0 }, tank: { level: 0 }, elevator: { pos: 0 }, smartFactory: { bottlePos: -50, bottleFill: 0, tankLevel: 100, capProgress: 0, currentBottleQuality: true, goodCount: 0, rejectCount: 0, batchTarget: 10, rejected: false, packaged: false, activeStation: 'Start' }, batchCount: { boxPos: 0 }, shiftReg: { animOffset: 0 }, tankLevel: { rawLevel: 0 }, tempFan: { rawTemp: 1024 }, pressureAlarm: { rawPress: 0 } });
    setPhysicalInputs({});
    setRungs(prevRungs => prevRungs.map(r => ({ ...r, outputs: r.outputs.map(o => ({ ...o, state: false, accum: ['ctd','inc','dec','mov','sft','mul','div', 'scale', 'limit', 'add', 'sub'].includes(o.type) ? (o.type==='ctd'?o.preset:0) : 0, doneBit: false, lastState: false })) })));
    latchedTags.current = {};
    let initRegs = { D0: 0, D1: 0, D2: 10, D3: 0, D4: 0, D5: 0, D6: 0, D7: 0 };
    if (selectedPlant === 'tankLevel') initRegs = { D0: 0, D1: 0, D2: 60, D3: 85, D4: 25, D5: 0, D6: 0, D7: 0 };
    if (selectedPlant === 'tempFan') initRegs = { D0: 1024, D1: 25, D2: 30, D3: 45, D4: 0, D5: 0, D6: 0, D7: 0 };
    if (selectedPlant === 'pressureAlarm') initRegs = { D0: 0, D1: 0, D2: 5, D3: 7, D4: 8, D5: 0, D6: 0, D7: 0 };
    setDataRegisters(initRegs); setShiftRegisters({ SR0: [0, 0, 0, 0, 0, 0, 0, 0] });
  };
  ...
  const executeSubmission = (e) => {
    ...
    const payload = {
      ...
      ioMap, rungs, dataRegisters, shiftRegisters, selectedCategory, timestamp: new Date().toISOString(), appVersion: "4.0.0"
    };
    ...
    if (submissionType === 'save') {
      ...
      const copyFn = () => {
        ...
        try { document.execCommand('copy'); alert("Submission code copied."); } catch (err) { alert("Failed to copy."); } document.body.removeChild(ta);
      };
    ...
    reader.onload = (event) => {
      try {
        ...
        if ((data.plant || data.plantKey) && data.rungs && data.ioMap) {
          ...
          if (data.dataRegisters) setDataRegisters(data.dataRegisters); if (data.shiftRegisters) setShiftRegisters(data.shiftRegisters);
  ...
  useEffect(() => {
    ...
    setPlantState(prev => {
      ...
      if (selectedPlant === 'bottle') {
        let { pos, fill, count } = next.bottle; if (isOutputOn('O:0/0')) pos += 15; const isPresent = pos >= 440 && pos <= 460;
        if (isOutputOn('O:0/1') && isPresent) fill += 5; if (fill > 100) fill = 100; const isFull = (fill >= 100) && isPresent;
        if (pos > 1200) { pos = -200; fill = 0; count += 1; } next.bottle = { pos, fill, count };
        setPhysicalInputs(inputs => { if (inputs['I:0/2'] !== isPresent || inputs['I:0/3'] !== isFull) return { ...inputs, 'I:0/2': isPresent, 'I:0/3': isFull }; return inputs; });
      }
      if (selectedPlant === 'garage') {
        let { pos } = next.garage; const motorUp = isOutputOn('O:0/0'), motorDn = isOutputOn('O:0/1'), photoEye = physicalInputs['I:0/4'] || false;
        if (motorUp && !motorDn && pos < 100) pos += 2; if (motorDn && !motorUp && pos > 0 && !photoEye) pos -= 2;
        if (pos > 100) pos = 100; if (pos < 0) pos = 0; next.garage = { pos };
        setPhysicalInputs(inputs => { const upLim = pos >= 100, dnLim = pos <= 0; if (inputs['I:0/2'] !== upLim || inputs['I:0/3'] !== dnLim) return { ...inputs, 'I:0/2': upLim, 'I:0/3': dnLim }; return inputs; });
      }
      if (selectedPlant === 'tank') {
        let { level } = next.tank; if (isOutputOn('O:0/0')) level += 1.5; if (isOutputOn('O:0/1')) level -= 1.5; 
        if (level > 100) level = 100; if (level < 0) level = 0; next.tank = { level };
        setPhysicalInputs(inputs => { const lowSens = level <= 5, highSens = level >= 95; if (inputs['I:0/2'] !== lowSens || inputs['I:0/3'] !== highSens) return { ...inputs, 'I:0/2': lowSens, 'I:0/3': highSens }; return inputs; });
      }
      if (selectedPlant === 'elevator') {
        let { pos } = next.elevator; if (isOutputOn('O:0/0')) pos += 1.0; if (isOutputOn('O:0/1')) pos -= 1.0; 
        pos = Math.round(pos * 10) / 10; if (pos > 100) pos = 100; if (pos < 0) pos = 0; next.elevator = { pos };
        setPhysicalInputs(inputs => { const sensG = pos === 0, sens1 = pos === 50, sens2 = pos === 100; if (inputs['I:0/3'] !== sensG || inputs['I:0/4'] !== sens1 || inputs['I:0/5'] !== sens2) return { ...inputs, 'I:0/3': sensG, 'I:0/4': sens1, 'I:0/5': sens2 }; return inputs; });
      }
      ...
      if (selectedPlant === 'smartFactory') {
        ...
        setPhysicalInputs(inputs => { if(inputs['I:0/4'] !== entrySens || inputs['I:0/5'] !== atFill || inputs['I:0/6'] !== fullSens || inputs['I:0/7'] !== atCap || inputs['I:1/0'] !== capDoneSens || inputs['I:1/3'] !== isTankLow) return { ...inputs, 'I:0/4': entrySens, 'I:0/5': atFill, 'I:0/6': fullSens, 'I:0/7': atCap, 'I:1/0': capDoneSens, 'I:1/3': isTankLow }; return inputs; });
      ...
      if (selectedPlant === 'batchCount') {
        let { boxPos } = next.batchCount; if (isOutputOn('O:0/0')) boxPos += 5;
        const inSensor = boxPos >= 45 && boxPos <= 55; if (boxPos > 120) boxPos = 0; next.batchCount = { boxPos };
        setPhysicalInputs(inputs => { if (inputs['I:0/2'] !== inSensor) return { ...inputs, 'I:0/2': inSensor }; return inputs; });
      }

      if (selectedPlant === 'shiftReg') {
        let { animOffset } = next.shiftReg;
        if (isOutputOn('O:0/0')) { animOffset += 2; const pulse = animOffset >= 18 && animOffset <= 20; if (animOffset > 20) animOffset = 0; next.shiftReg = { animOffset }; setPhysicalInputs(inputs => { if (inputs['I:0/4'] !== pulse) return { ...inputs, 'I:0/4': pulse }; return inputs; }); }
      }

      if (selectedPlant === 'tankLevel') {
        let { rawLevel } = next.tankLevel;
        if (isOutputOn('O:0/0')) rawLevel += 15; if (isOutputOn('O:0/1') || physicalInputs['I:0/3']) rawLevel -= 15;
        if (rawLevel > 4095) rawLevel = 4095; if (rawLevel < 0) rawLevel = 0;
        dataRegsRef.current['D0'] = Math.round(rawLevel); next.tankLevel = { rawLevel };
      }

      if (selectedPlant === 'tempFan') {
        let { rawTemp } = next.tempFan; let ambient = 1024;
        if (isOutputOn('O:0/0')) rawTemp += 10; if (isOutputOn('O:0/1')) rawTemp -= (dataRegsRef.current['D5'] > 0 ? (dataRegsRef.current['D5'] * 0.1) : 5);
        if (physicalInputs['I:0/3']) { rawTemp += (ambient - rawTemp) * 0.05; } else { rawTemp += (ambient - rawTemp) * 0.01; }
        if (rawTemp > 4095) rawTemp = 4095; if (rawTemp < 0) rawTemp = 0;
        dataRegsRef.current['D0'] = Math.round(rawTemp); next.tempFan = { rawTemp };
      }

      if (selectedPlant === 'pressureAlarm') {
        let { rawPress } = next.pressureAlarm;
        if (isOutputOn('O:0/0')) rawPress += 20; if (isOutputOn('O:0/1') || physicalInputs['I:0/3']) rawPress -= 50;
        rawPress -= 2; if (rawPress > 4095) rawPress = 4095; if (rawPress < 0) rawPress = 0;
        dataRegsRef.current['D0'] = Math.round(rawPress); next.pressureAlarm = { rawPress };
      }
      return next;
    });
  ...
  useEffect(() => {
    ...
    const getVal = (param) => { if (!param && param !== 0) return 0; if (typeof param === 'string' && param.startsWith('D')) return parseInt(dataRegsRef.current[param]) || 0; return parseInt(param) || 0; };
    ...
    setRungs(prevRungs => {
      ...
      const getContactPower = (contact) => {
        if (contact.type === 'CMP') {
            const left = getVal(contact.cmpLeft), right = getVal(contact.cmpRight);
            switch(contact.cmpOp) { case '==': return left === right; case '!=': return left !== right; case '>': return left > right; case '<': return left < right; case '>=': return left >= right; case '<=': return left <= right; default: return false; }
        }
      ...
      for (let i = 0; i < nextRungs.length; i++) {
        ...
        for (let j = 0; j < rung.outputs.length; j++) {
          ...
          if (['inc', 'dec', 'mov', 'sft', 'mul', 'div', 'scale', 'limit', 'add', 'sub'].includes(out.type)) {
              ...
              if (out.type === 'add' && isRungTrue && out.dest) dataRegsRef.current[out.dest] = getVal(out.srcA) + getVal(out.srcB);
              if (out.type === 'sub' && isRungTrue && out.dest) dataRegsRef.current[out.dest] = getVal(out.srcA) - getVal(out.srcB);
              if (out.type === 'sft' && isRising && out.dest) { let arr = [...(shiftRegsRef.current[out.dest] || [0,0,0,0,0,0,0,0])]; arr.unshift(getVal(out.srcA)); arr.pop(); shiftRegsRef.current[out.dest] = arr; }
              if (out.type === 'mul' && isRungTrue && out.dest) dataRegsRef.current[out.dest] = getVal(out.srcA) * getVal(out.srcB);
              if (out.type === 'div' && isRungTrue && out.dest) { const b = getVal(out.srcB); if (b !== 0) { dataRegsRef.current[out.dest] = Math.floor(getVal(out.srcA) / b); } else { dataRegsRef.current['D7'] = 1; } }
              if (out.type === 'scale' && isRungTrue && out.dest) {
                 let raw = getVal(out.srcA), rMin = getVal(out.rawMin) || 0, rMax = getVal(out.rawMax) || 4095, eMin = getVal(out.engMin) || 0, eMax = getVal(out.engMax) || 100;
                 if (rMax === rMin) rMax = rMin + 1; let scaled = ((raw - rMin) * (eMax - eMin) / (rMax - rMin)) + eMin;
                 if (scaled < Math.min(eMin, eMax)) scaled = Math.min(eMin, eMax); if (scaled > Math.max(eMin, eMax)) scaled = Math.max(eMin, eMax);
                 dataRegsRef.current[out.dest] = Math.round(scaled);
              }
              if (out.type === 'limit' && isRungTrue && out.dest) {
                 let val = getVal(out.srcA), min = getVal(out.min) || 0, max = getVal(out.max) || 100;
                 if (val < min) val = min; if (val > max) val = max; dataRegsRef.current[out.dest] = val;
              }
              newState = isRungTrue;
          }
          else if (out.type === 'timer') { if (isRungTrue) { newAccum = Math.round((newAccum + 0.1) * 10) / 10; if (newAccum >= out.preset) { newAccum = out.preset; newDoneBit = true; } } else { newAccum = 0; newDoneBit = false; } newState = isRungTrue;
          } else if (out.type === 'tof') { if (isRungTrue) { newAccum = 0; newDoneBit = true; newState = true; } else { newState = false; if (newDoneBit) { newAccum = Math.round((newAccum + 0.1) * 10) / 10; if (newAccum >= out.preset) { newAccum = out.preset; newDoneBit = false; } } }
          } else if (out.type === 'rto') { if (isRungTrue) { if (newAccum < out.preset) newAccum = Math.round((newAccum + 0.1) * 10) / 10; if (newAccum >= out.preset) newDoneBit = true; } newState = isRungTrue;
          } else if (out.type === 'counter') { if (isRungTrue && !out.lastState) newAccum += 1; if (newAccum >= out.preset) newDoneBit = true; newState = isRungTrue;
          } else if (out.type === 'ctd') { if (isRungTrue && !out.lastState) newAccum -= 1; if (newAccum <= 0) newDoneBit = true; newState = isRungTrue;
      ...
      setDataRegisters({ ...dataRegsRef.current }); setShiftRegisters({ ...shiftRegsRef.current });
      return changed ? nextRungs : prevRungs;
    });
  }, [physicalInputs, ioMap, isRunning, tick]);

  useEffect(() => { const handleDocClick = () => setEditMenuId(null); document.addEventListener('click', handleDocClick); return () => document.removeEventListener('click', handleDocClick); }, []);

  // --- HANDLERS ---
  const handleAddIO = (e) => { e.preventDefault(); if (!newIO.address || !newIO.tag) return; if (ioMap.some(io => io.address === newIO.address)) return alert("Address already exists!"); setIoMap([...ioMap, { id: genId('io'), customTag: newIO.tag, tag_en: newIO.tag, tag_zh: newIO.tag, ...newIO }]); if (newIO.type === 'input') setPhysicalInputs(prev => ({ ...prev, [newIO.address]: false })); setNewIO({ type: 'input', address: '', tag: '', mode: 'toggle' }); };
  ...
  const pressMomentaryInput = (address) => { if (!isRunning) return; setPhysicalInputs(prev => ({ ...prev, [address]: true })); };
  const releaseMomentaryInput = (address) => { setPhysicalInputs(prev => ({ ...prev, [address]: false })); };
  const updateDataReg = (reg, val) => { if (isRunning) return; setDataRegisters(prev => ({ ...prev, [reg]: parseInt(val) || 0 })); dataRegsRef.current[reg] = parseInt(val) || 0; };
  ...
  const getSfRuntimeAction = () => {
    if (!isRunning) return t('step4'); const s = plantState.smartFactory;
    const isEStop = physicalInputs['I:0/2'] === true, isRejectFull = physicalInputs['I:1/2'] === true, isTankLow = s.tankLevel <= 10;
  ...
  const getSfWhyNotRunning = () => {
    const reasons = []; const s = plantState.smartFactory;
    if (physicalInputs['I:0/2']) reasons.push(t('eStop'));
    if (physicalInputs['I:1/2']) reasons.push(t('rejectFull'));
    if (s.tankLevel <= 10) reasons.push(t('tankLow'));
    ...
    if (cData.type === 'CMP') {
      return (
        <div className="w-full h-full flex flex-col items-center justify-center border-2 border-blue-500 rounded bg-blue-50 px-1 text-[8px] font-bold font-mono text-blue-900 group-hover/contact:bg-blue-200">
           <span>CMP</span><span>{cData.cmpLeft || '?'} {cData.cmpOp || '=='} {cData.cmpRight || '?'}</span>
        </div>
      );
    }
    return (
        ...
        <header className="bg-white border-b border-slate-200 px-8 pt-4 pb-0 shadow-sm flex flex-col shrink-0 relative z-40">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center w-full mb-4 gap-4">
            <h1 className="text-2xl font-bold text-slate-900 flex items-center gap-4">
              ...
              {lang === 'en' ? (PLANT_TEMPLATES[selectedPlant]?.name_en || INTERMEDIATE_MODULES.find(m=>m.key===selectedPlant)?.name_en || ANALOG_MODULES.find(m=>m.key===selectedPlant)?.name_en) : (PLANT_TEMPLATES[selectedPlant]?.name_zh || INTERMEDIATE_MODULES.find(m=>m.key===selectedPlant)?.name_zh || ANALOG_MODULES.find(m=>m.key===selectedPlant)?.name_zh)}
            </h1>
          ...
          <div className="flex flex-col xl:flex-row justify-between items-start xl:items-end w-full gap-4">
            ...
            <div className="flex items-center gap-4 flex-wrap justify-end mb-3">
               <select value={plcBrand} onChange={(e) => setPlcBrand(e.target.value)} className="px-3 py-2 border border-slate-300 rounded-lg text-xs font-bold text-slate-700 bg-white outline-none cursor-pointer shadow-sm hover:border-blue-400">
                 <option value="generic">{t('brand_generic')}</option><option value="siemens">{t('brand_siemens')}</option><option value="mitsubishi">{t('brand_mitsubishi')}</option>
               </select>
               <button onClick={resetSimulation} className="px-4 py-2.5 rounded-lg font-bold text-sm transition-all flex items-center gap-2 bg-slate-200 hover:bg-slate-300 text-slate-700 shadow-sm border border-slate-300 whitespace-nowrap">{t('resetSim')}</button>
               <button onClick={() => setIsRunning(!isRunning)} className={`px-6 py-2.5 rounded-lg font-bold text-sm transition-all flex items-center gap-3 shadow-sm whitespace-nowrap ${isRunning ? 'bg-red-500 hover:bg-red-600 text-white shadow-red-500/30' : 'bg-green-500 hover:bg-green-600 text-white shadow-green-500/30'}`}>
                 <div className={`w-2.5 h-2.5 rounded-full ${isRunning ? 'bg-red-200 animate-pulse' : 'bg-green-200'}`}></div>{isRunning ? t('stopSystem') : t('runSystem')}
               </button>
            </div>
          </div>
        </header>
          ...
          <div className="max-w-5xl mx-auto py-12 px-8 relative flex-1 w-full">
            <div className="flex flex-col sm:flex-row items-center justify-center text-center sm:text-left mb-10 pb-10 border-b border-slate-200 gap-6">
              <div className="w-24 h-24 sm:w-32 sm:h-32 rounded-full bg-slate-100 flex items-center justify-center overflow-hidden border-4 border-white shadow-lg shrink-0">
                 <img src="/umpsa-logo.png" alt="UMPSA Logo" className="w-full h-full object-contain p-2" onError={(e) => { e.target.src = 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" fill="%23cbd5e1"><path d="M50 10 L90 30 L90 70 L50 90 L10 70 L10 30 Z" /></svg>'; }} />
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div onClick={() => setSelectedCategory('basic')} className="bg-white rounded-2xl p-8 border-2 border-slate-200 hover:border-blue-500 hover:shadow-xl transition-all cursor-pointer flex flex-col group">
                  ...
                  <div className="bg-slate-50 p-4 rounded-lg border border-slate-100 mb-6">
                    ...
                    <ul className="text-xs text-slate-600 space-y-1.5 list-disc list-inside">
                      <li>{t('conceptBasic1')}</li><li>{t('conceptBasic2')}</li><li>{t('conceptBasic3')}</li><li>{t('conceptBasic4')}</li>
                    </ul>
                  </div>
                ...
                <div onClick={() => setSelectedCategory('intermediate')} className="bg-white rounded-2xl p-8 border-2 border-slate-200 hover:border-purple-500 hover:shadow-xl transition-all cursor-pointer flex flex-col group">
                  ...
                  <div className="bg-slate-50 p-4 rounded-lg border border-slate-100 mb-6">
                    <h4 className="font-bold text-xs text-slate-700 uppercase tracking-wider mb-2">{t('learningOutcomes')}</h4>
                    <ul className="text-xs text-slate-600 space-y-1.5 list-disc list-inside">
                      <li>{t('conceptInt1')}</li><li>{t('conceptInt2')}</li><li>{t('conceptInt3')}</li><li>{t('conceptInt4')}</li><li>{t('conceptInt5')}</li>
                    </ul>
                  </div>
                ...
                <div onClick={() => setSelectedCategory('analog')} className="bg-white rounded-2xl p-8 border-2 border-slate-200 hover:border-emerald-500 hover:shadow-xl transition-all cursor-pointer flex flex-col group">
                  ...
                  <div className="bg-slate-50 p-4 rounded-lg border border-slate-100 mb-6">
                    <h4 className="font-bold text-xs text-slate-700 uppercase tracking-wider mb-2">{t('learningOutcomes')}</h4>
                    <ul className="text-xs text-slate-600 space-y-1.5 list-disc list-inside">
                      <li>{t('conceptAna1')}</li><li>{t('conceptAna2')}</li><li>{t('conceptAna3')}</li><li>{t('conceptAna4')}</li><li>{t('conceptAna5')}</li>
                    </ul>
                  </div>
            ...
            {selectedCategory === 'basic' && (
              <div className="animate-in fade-in duration-300">
                <button onClick={() => setSelectedCategory(null)} className="mb-6 font-bold text-slate-500 hover:text-slate-800 flex items-center gap-2 transition-colors">{t('backToModules')}</button>
                ...
                <div className="bg-slate-50 border border-slate-200 rounded-xl p-6 mb-8 shadow-sm">
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 gap-4 border-b border-slate-200 pb-4">
                     <div><h3 className="text-lg font-bold text-slate-800">{t('plcSystemMode')}</h3><p className="text-xs text-slate-500 mt-1 max-w-md leading-relaxed">{t('vendorNeutralNote')}</p></div>
                     <select value={plcBrand} onChange={(e) => setPlcBrand(e.target.value)} className="px-4 py-3 border border-slate-300 rounded-lg font-bold text-slate-700 bg-white outline-none cursor-pointer shadow-sm hover:border-blue-400 focus:ring-2 focus:ring-blue-100">
                       <option value="generic">{t('brand_generic')}</option><option value="siemens">{t('brand_siemens')}</option><option value="mitsubishi">{t('brand_mitsubishi')}</option>
                     </select>
                  </div>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 mb-12 text-left shadow-sm">
                  ...
                  <ol className="list-decimal list-inside text-slate-700 space-y-1.5 mb-5 text-sm font-medium">
                    <li>{t('step1')}</li><li>{t('step2')}</li><li>{t('step3')}</li><li>{t('step4')}</li><li>{t('step5')}</li><li>{t('step6')}</li><li>{t('step7')}</li>
                  </ol>
                        ...
                        <table className="w-full">
                           <tbody>
                             {template.ioMap.slice(0, 5).map(io => (
                               <tr key={io.id}><td className="text-slate-600 font-medium py-0.5 pr-2 truncate max-w-[120px]">{lang === 'en' ? io.tag_en : io.tag_zh}</td><td className="text-right font-mono text-blue-600 font-bold py-0.5">{formatAddress(io.address, plcBrand)}</td></tr>
                             ))}
                           </tbody>
                        </table>
              ...
              <div className="animate-in fade-in duration-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {ANALOG_MODULES.map((mod) => (
                    <div key={mod.key} onClick={() => loadTemplate(mod.key)} className="bg-white rounded-2xl p-6 border-2 border-slate-200 hover:border-emerald-500 hover:shadow-xl transition-all cursor-pointer group flex flex-col h-full relative overflow-hidden">
                      <div className={`absolute top-0 right-0 left-0 text-[10px] font-bold text-center py-1 uppercase tracking-widest bg-emerald-100 text-emerald-700`}>Analog Exercise</div>
                      <h3 className="text-xl font-bold text-slate-800 mb-2 mt-4 group-hover:text-emerald-600 transition-colors">{lang === 'en' ? mod.name_en : mod.name_zh}</h3>
                      <p className="text-sm text-slate-500 flex-1 mb-4">{lang === 'en' ? mod.desc_en : mod.desc_zh}</p>
                      <div className="bg-slate-50 p-3 rounded border border-slate-200">
                        <ul className="text-[10px] text-slate-600 space-y-1 list-disc list-inside font-medium">
                          {(lang === 'en' ? mod.concepts_en : mod.concepts_zh).map((c, i) => <li key={i}>{c}</li>)}
        ...
        {(activeTab === 'simulator' || activeTab === 'process') && (
          <div className="flex-1 flex flex-col gap-6 w-full max-w-[90rem] mx-auto p-8" onClick={() => setEditMenuId(null)}>
            ...
            <div className="flex flex-col lg:flex-row gap-6 shrink-0">
              ...
              {/* Data Registers Panel */}
              {(['batchCount', 'shiftReg', 'interlock', 'tankLevel', 'tempFan', 'pressureAlarm'].includes(selectedPlant)) && (
                <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-200 lg:w-80 shrink-0">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {['D0', 'D1', 'D2', 'D3', 'D4', 'D5', 'D6', 'D7'].map(reg => (
                      <div key={reg} className="flex flex-col justify-center bg-purple-50 p-2 rounded border border-purple-100">
                        <span className="font-mono text-[9px] font-bold text-purple-700 mb-1">{getRegLabel(reg)}</span>
                        <div className="flex items-center justify-between">
                          <span className="font-mono text-xs font-bold text-slate-400">{reg}</span>
                          {isRunning ? (
                            <span className="text-sm font-bold text-slate-800">{dataRegisters[reg]}</span>
                          ) : (
                            <input type="number" className="w-16 p-1 text-xs border border-purple-200 rounded outline-none text-right font-bold bg-white" value={dataRegisters[reg]} onChange={(e) => updateDataReg(reg, e.target.value)} />
                          )}
                        </div>
                      </div>
                    ))}
                    ...
                    <div className="mt-3 pt-3 border-t border-slate-100">
                      ...
                      <div className="flex gap-1">
                        {shiftRegisters.SR0.map((val, i) => (
                          <div key={i} className={`flex-1 h-6 rounded flex items-center justify-center text-xs font-bold text-white shadow-sm ${val === 1 ? 'bg-green-500' : val === 2 ? 'bg-red-500' : 'bg-slate-300'}`}>{val}</div>
                        ))}
                      </div>
                    </div>
                  )}
                          ...
                          const evaluatedBranches = node.branches.map(branch => {
                            ...
                            const evaluatedContacts = branch.map(contact => {
                              if (contact.type === 'CMP') {
                                ...
                                const left = getV(contact.cmpLeft), right = getV(contact.cmpRight);
                                let res = false;
                                switch(contact.cmpOp) { case '==': res = left === right; break; case '!=': res = left !== right; break; case '>': res = left > right; break; case '<': res = left < right; break; case '>=': res = left >= right; break; case '<=': res = left <= right; break; default: res = false; }
                                    ...
                                    {branchData.contacts.map((cData, cIdx) => (
                                      <React.Fragment key={cData.id}>
                                        <div className="flex flex-col items-center mx-2 relative group/contact">
                                          {!isRunning && (
                                            <button 
                                              type="button" onClick={(e) => { e.stopPropagation(); setEditMenuId(editMenuId === cData.id ? null : cData.id); }} 
                                            ...
                                            <div className="bg-white border border-slate-200 shadow-lg rounded p-1 flex gap-1" onClick={e => e.stopPropagation()}>
                                              ...
                                              {cData.type === 'CMP' ? (
                                                <div className="flex gap-1 mt-1">
                                                  ...
                                                  <select value={cData.cmpOp || '=='} onChange={(e) => updateContact(rung.id, node.id, bIdx, cData.id, 'cmpOp', e.target.value)} className="w-10 text-xs p-1 border rounded text-center"><option value="==">==</option><option value="!=">!=</option><option value=">">&gt;</option><option value="<">&lt;</option><option value=">=">&gt;=</option><option value="<=">&lt;=</option></select>
                                          ...
                                          {cData.type !== 'CMP' && <span className="text-[10px] font-bold text-blue-700 mb-1 truncate w-16 text-center" title={getIoTag(ioMap.find(io => io.address === cData.address))}>{getIoTag(ioMap.find(io => io.address === cData.address)) || <span className="text-red-400 italic">...</span>}</span>}
                                          ...
                                          {cData.type !== 'CMP' && <span className="text-[9px] font-mono text-slate-400 mt-1">{formatAddress(cData.address, plcBrand) || '?'}</span>}
                                        </div>
                          ...
                          {rung.outputs.map((out, oIdx) => (
                            <div key={out.id} className="flex flex-row items-center h-16 relative">
                              ...
                              <div className="flex flex-col items-center px-4 relative group/coil z-10">
                                {!isRunning && (
                                  <button 
                                    type="button" onClick={(e) => { e.stopPropagation(); setEditMenuId(editMenuId === out.id ? null : out.id); }} 
                                    className="absolute -top-3 -right-3 w-6 h-6 bg-white border border-slate-300 rounded-full flex items-center justify-center text-xs text-slate-500 shadow-sm lg:hidden z-30"
                                  >⚙️</button>
                                )}
                                <div className={`absolute bottom-[100%] left-1/2 -translate-x-1/2 pb-2 z-50 ${isRunning ? 'hidden' : (editMenuId === out.id ? 'opacity-100 pointer-events-auto' : 'opacity-0 lg:group-hover/coil:opacity-100 pointer-events-none lg:group-hover/coil:pointer-events-auto')} transition-opacity`}>
                                  <div className="bg-white border border-slate-200 shadow-lg rounded p-2 flex flex-col gap-2 min-w-[220px]" onClick={e => e.stopPropagation()}>
                                    <select value={out.type || 'coil'} onChange={(e) => updateOutputField(rung.id, out.id, 'type', e.target.value)} className="text-xs p-1 border rounded outline-none font-bold w-full">
                                      <optgroup label="Standard"><option value="coil">Coil ()</option><option value="set">Set (SET)</option><option value="reset">Reset (RES)</option><option value="difu">DIFU (↑)</option><option value="difd">DIFD (↓)</option></optgroup>
                                      <optgroup label="Timers/Counters"><option value="timer">Timer (TON)</option><option value="tof">Timer (TOF)</option><option value="rto">Timer (RTO)</option><option value="counter">Counter (CTU)</option><option value="ctd">Counter (CTD)</option></optgroup>
                                      <optgroup label="Analog / Math"><option value="inc">INC (Increment)</option><option value="dec">DEC (Decrement)</option><option value="mov">MOV (Move)</option><option value="scale">SCALE (Map Range)</option><option value="limit">LIMIT (Clamp)</option><option value="add">ADD (A + B)</option><option value="sub">SUB (A - B)</option><option value="mul">MUL (Multiply)</option><option value="div">DIV (Divide)</option><option value="sft">SFT (Shift Reg)</option></optgroup>
                                    </select>
                                    {['inc', 'dec', 'mov', 'sft', 'mul', 'div', 'add', 'sub', 'scale', 'limit'].includes(out.type) ? (
                                      <div className="flex flex-col gap-1 mt-1 bg-slate-50 p-2 rounded border border-slate-100">
                                        {['mov', 'sft', 'mul', 'div', 'add', 'sub', 'scale', 'limit'].includes(out.type) && <div className="flex justify-between items-center"><label className="text-[10px] text-slate-500">Src A:</label><input type="text" value={out.srcA || ''} onChange={(e) => updateOutputField(rung.id, out.id, 'srcA', e.target.value)} className="w-16 p-1 text-xs border rounded text-center" placeholder="D0" /></div>}
                                        {['mul', 'div', 'add', 'sub'].includes(out.type) && <div className="flex justify-between items-center"><label className="text-[10px] text-slate-500">Src B:</label><input type="text" value={out.srcB || ''} onChange={(e) => updateOutputField(rung.id, out.id, 'srcB', e.target.value)} className="w-16 p-1 text-xs border rounded text-center" placeholder="10" /></div>}
                                        {out.type === 'scale' && (
                                          <><div className="flex justify-between items-center"><label className="text-[10px] text-slate-500">Raw Min:</label><input type="text" value={out.rawMin || ''} onChange={(e) => updateOutputField(rung.id, out.id, 'rawMin', e.target.value)} className="w-16 p-1 text-xs border rounded text-center" placeholder="0" /></div>
                                          <div className="flex justify-between items-center"><label className="text-[10px] text-slate-500">Raw Max:</label><input type="text" value={out.rawMax || ''} onChange={(e) => updateOutputField(rung.id, out.id, 'rawMax', e.target.value)} className="w-16 p-1 text-xs border rounded text-center" placeholder="4095" /></div>
                                          <div className="flex justify-between items-center"><label className="text-[10px] text-slate-500">Eng Min:</label><input type="text" value={out.engMin || ''} onChange={(e) => updateOutputField(rung.id, out.id, 'engMin', e.target.value)} className="w-16 p-1 text-xs border rounded text-center" placeholder="0" /></div>
                                          <div className="flex justify-between items-center"><label className="text-[10px] text-slate-500">Eng Max:</label><input type="text" value={out.engMax || ''} onChange={(e) => updateOutputField(rung.id, out.id, 'engMax', e.target.value)} className="w-16 p-1 text-xs border rounded text-center" placeholder="100" /></div></>
                                        )}
                                        {out.type === 'limit' && (
                                          <><div className="flex justify-between items-center"><label className="text-[10px] text-slate-500">Min:</label><input type="text" value={out.min || ''} onChange={(e) => updateOutputField(rung.id, out.id, 'min', e.target.value)} className="w-16 p-1 text-xs border rounded text-center" placeholder="0" /></div>
                                          <div className="flex justify-between items-center"><label className="text-[10px] text-slate-500">Max:</label><input type="text" value={out.max || ''} onChange={(e) => updateOutputField(rung.id, out.id, 'max', e.target.value)} className="w-16 p-1 text-xs border rounded text-center" placeholder="100" /></div></>
                                        )}
                                ...
                                {!['inc', 'dec', 'mov', 'sft', 'mul', 'div', 'scale', 'limit', 'add', 'sub'].includes(out.type) && (
                                ...
                                {['timer','tof','rto','counter','ctd'].includes(out.type) ? (
                                  ...
                                  <div className={`w-28 h-12 border-2 rounded flex flex-col items-center justify-center transition-colors relative ${out.state ? 'border-purple-400 bg-purple-50 shadow-[0_0_10px_rgba(168,85,247,0.5)]' : 'border-slate-300 bg-slate-50'}`}>
                                    ...
                                    <div className="flex gap-2 text-[8px] mt-1 font-mono font-bold text-slate-700">
                                      {out.type === 'inc' && <span>{out.dest || '?'} + 1</span>}{out.type === 'dec' && <span>{out.dest || '?'} - 1</span>}{out.type === 'mov' && <span>{out.srcA || '?'} → {out.dest || '?'}</span>}{out.type === 'sft' && <span>{out.srcA || '?'} ⟫ {out.dest || '?'}</span>}{out.type === 'mul' && <span>{out.srcA || '?'} × {out.srcB || '?'} → {out.dest || '?'}</span>}{out.type === 'div' && <span>{out.srcA || '?'} ÷ {out.srcB || '?'} → {out.dest || '?'}</span>}{out.type === 'add' && <span>{out.srcA || '?'} + {out.srcB || '?'} → {out.dest || '?'}</span>}{out.type === 'sub' && <span>{out.srcA || '?'} - {out.srcB || '?'} → {out.dest || '?'}</span>}{out.type === 'scale' && <span>{out.srcA || '?'} → SCL → {out.dest || '?'}</span>}{out.type === 'limit' && <span>{out.srcA || '?'} → LMT → {out.dest || '?'}</span>}
                                    </div>
                                  </div>
                                ) : (
                              ...
                              <div className={`flex-1 min-w-[20px] h-1.5 transition-colors ${out.doneBit || (['coil','reset','set','difu','difd', 'inc', 'dec', 'mov', 'sft', 'mul', 'div', 'scale', 'limit', 'add', 'sub'].includes(out.type) && out.state) ? 'bg-blue-400' : 'bg-blue-500'} shrink-0`}></div>
                  ...
                  <div className="w-full aspect-video max-h-[800px] bg-slate-900 rounded-lg overflow-hidden flex items-center justify-center border-4 border-slate-700 shadow-inner relative mt-4">
                     ...
                     {selectedPlant === 'bottle' && (
                       <svg viewBox="0 0 1000 600" className="w-full h-full object-contain">
                         ...
                         <text x="35" y="50" fill="#94a3b8" fontSize="16" fontWeight="bold" fontFamily="monospace">{t('bottles')}:</text><text x="130" y="50" fill="#22c55e" fontSize="24" fontWeight="bold" fontFamily="monospace">{plantState.bottle.count}</text>
                         ...
                         {Array.from({length: 20}).map((_, i) => ( <g key={i} transform={`translate(${25 + i*50}, 490)`}><circle r="20" fill="#94a3b8" />{isOutputOn('O:0/0') && ( <g transform={`rotate(${tick * 20 % 360})`}><line x1="-15" y1="0" x2="15" y2="0" stroke="#475569" strokeWidth="4" /><line x1="0" y1="-15" x2="0" y2="15" stroke="#475569" strokeWidth="4" /></g> )}</g> ))}
                         ...
                         <g transform={`translate(${plantState.bottle.pos}, 250)`}><rect x="0" y="0" width="100" height="200" rx="5" fill="rgba(255,255,255,0.1)" stroke="white" strokeWidth="4" /><rect x="4" y={196 - plantState.bottle.fill * 1.92} width="92" height={plantState.bottle.fill * 1.92} fill="#3b82f6" /><rect x="10" y="10" width="10" height="180" fill="white" opacity="0.2" rx="5" /></g>
                       </svg>
                     )}
                     {/* ---- 2. GARAGE DOOR ---- */}
                     {selectedPlant === 'garage' && (
                       <svg viewBox="0 0 1000 600" className="w-full h-full object-contain">
                         ...
                         <g transform={`translate(0, ${-plantState.garage.pos * 4})`}>
                            ...
                            {Array.from({length: 8}).map((_, i) => ( <line key={i} x1="250" y1={200 + i*50} x2="750" y2={200 + i*50} stroke="#94a3b8" strokeWidth="4" /> ))}
                         </g>
                     ...
                     {selectedPlant === 'batchCount' && (
                       <svg viewBox="0 0 1000 600" className="w-full h-full object-contain">
                         ...
                         <text x="410" y="250" fill="white" fontSize="14" fontWeight="bold" textAnchor="middle">{formatAddress('I:0/2', plcBrand)} Sensor</text>
                         <g transform="translate(600, 40)">
                           <rect x="0" y="0" width="350" height="150" fill="#0f172a" rx="10" stroke="#334155" strokeWidth="2" />
                           <text x="20" y="30" fill="#94a3b8" fontSize="14">Total (D0): <tspan fill="white">{dataRegisters['D0']}</tspan></text>
                           <text x="20" y="60" fill="#94a3b8" fontSize="14">Target (D2): <tspan fill="white">{dataRegisters['D2']}</tspan></text>
                           <circle cx="30" cy="120" r="10" fill={isOutputOn('O:0/2') ? '#22c55e' : '#475569'} />
                           <text x="50" y="125" fill={isOutputOn('O:0/2') ? '#22c55e' : '#94a3b8'} fontSize="14" fontWeight="bold">Batch Complete</text>
                         </g>
                       </svg>
                     )}
                       ...
                       <svg viewBox="0 0 1000 600" className="w-full h-full object-contain">
                         ...
                         {shiftRegisters.SR0.map((val, idx) => (
                           <g key={idx} transform={`translate(${50 + idx * 100}, 240)`}>
                             <rect x="10" y="0" width="80" height="60" fill={val===1?'#22c55e':val===2?'#ef4444':'rgba(255,255,255,0.1)'} rx="4" />
                     ...
                     {selectedPlant === 'interlock' && (
                       <svg viewBox="0 0 1000 600" className="w-full h-full object-contain">
                         ...
                         <g transform="translate(40, 100)">
                           ...
                           <text x="20" y="40" fill="#94a3b8" fontSize="16">Total (D0): <tspan fill="white">{dataRegisters['D0']}</tspan></text>
                           <text x="20" y="80" fill="#94a3b8" fontSize="16">Good (D1): <tspan fill="#22c55e">{dataRegisters['D1']}</tspan></text>
                           <text x="20" y="120" fill="#94a3b8" fontSize="16">Reject (D2): <tspan fill="#ef4444">{dataRegisters['D2']}</tspan></text>
                           <text x="20" y="200" fill="#94a3b8" fontSize="16">Reject % (D5): <tspan fill="#facc15">{dataRegisters['D5']}%</tspan></text>
                           <text x="20" y="240" fill="#94a3b8" fontSize="16">Good % (D6): <tspan fill="#22c55e">{dataRegisters['D6']}%</tspan></text>
                         </g>
                         <g transform="translate(500, 100)">
                           ...
                           <text x="70" y="85" fill={physicalInputs['I:0/2'] ? '#ef4444' : '#94a3b8'} fontSize="16">Guard Door Open</text>
                           <circle cx="40" cy="200" r="15" fill={isOutputOn('O:0/1') ? '#22c55e' : '#475569'} />
                           <text x="70" y="205" fill={isOutputOn('O:0/1') ? '#22c55e' : '#94a3b8'} fontSize="16">Interlock OK</text>
                         </g>
                       </svg>
                     )}

                     {/* ---- ANALOG: TANK LEVEL CONTROL ---- */}
                     {selectedPlant === 'tankLevel' && (
                       <svg viewBox="0 0 1000 600" className="w-full h-full object-contain">
                         <rect width="1000" height="600" fill="#1e293b" />
                         <text x="40" y="50" fill="white" fontSize="20" fontWeight="bold">Analog Tank Level Control</text>
                         <g transform="translate(400, 150)">
                           <rect x="0" y="0" width="200" height="400" fill="#0f172a" stroke="#475569" strokeWidth="6" rx="10" />
                           <rect x="6" y={394 - (plantState.tankLevel.rawLevel / 4095) * 388} width="188" height={(plantState.tankLevel.rawLevel / 4095) * 388} fill="#0ea5e9" opacity="0.8" rx="5" />
                           <line x1="-20" y1={400 - (dataRegisters['D3']/100)*400} x2="220" y2={400 - (dataRegisters['D3']/100)*400} stroke="#ef4444" strokeWidth="3" strokeDasharray="5 5" />
                           <text x="230" y={405 - (dataRegisters['D3']/100)*400} fill="#ef4444" fontSize="14">High Limit ({dataRegisters['D3']}%)</text>
                           <line x1="-20" y1={400 - (dataRegisters['D4']/100)*400} x2="220" y2={400 - (dataRegisters['D4']/100)*400} stroke="#facc15" strokeWidth="3" strokeDasharray="5 5" />
                           <text x="230" y={405 - (dataRegisters['D4']/100)*400} fill="#facc15" fontSize="14">Low Limit ({dataRegisters['D4']}%)</text>
                         </g>
                         <g transform="translate(40, 150)">
                           <rect width="300" height="280" fill="#0f172a" rx="10" stroke="#334155" strokeWidth="2" />
                           <text x="20" y="40" fill="#94a3b8" fontSize="16">Raw Input (D0): <tspan fill="white" fontWeight="bold">{dataRegisters['D0']} / 4095</tspan></text>
                           <text x="20" y="80" fill="#94a3b8" fontSize="16">Scaled Level (D1): <tspan fill="#3b82f6" fontWeight="bold">{dataRegisters['D1']} %</tspan></text>
                           <text x="20" y="120" fill="#94a3b8" fontSize="16">Setpoint (D2): <tspan fill="white" fontWeight="bold">{dataRegisters['D2']} %</tspan></text>
                           <text x="20" y="160" fill="#94a3b8" fontSize="16">Valve Out (D5): <tspan fill="#facc15" fontWeight="bold">{dataRegisters['D5']} %</tspan></text>
                           <rect x="20" y="180" width="260" height="15" fill="#334155" rx="5" />
                           <rect x="20" y="180" width={(dataRegisters['D5']/100)*260} height="15" fill="#facc15" rx="5" />
                         </g>
                         <circle cx="300" cy="150" r="25" fill={isOutputOn('O:0/0') ? '#22c55e' : '#475569'} />
                         <text x="300" y="155" fill="white" fontSize="12" fontWeight="bold" textAnchor="middle">PUMP</text>
                         <rect x="620" y="520" width="40" height="40" fill={isOutputOn('O:0/1') || physicalInputs['I:0/3'] ? '#facc15' : '#475569'} rx="5"/>
                         <text x="640" y="545" fill="#1e293b" fontSize="12" fontWeight="bold" textAnchor="middle">VALVE</text>
                         <path d="M 640 560 L 640 600" stroke={isOutputOn('O:0/1') || physicalInputs['I:0/3'] ? '#0ea5e9' : 'none'} strokeWidth="15"/>
                       </svg>
                     )}

                     {/* ---- ANALOG: TEMP FAN CONTROL ---- */}
                     {selectedPlant === 'tempFan' && (
                       <svg viewBox="0 0 1000 600" className="w-full h-full object-contain">
                         <rect width="1000" height="600" fill="#1e293b" />
                         <text x="40" y="50" fill="white" fontSize="20" fontWeight="bold">Temperature & Fan Speed Control</text>
                         <g transform="translate(500, 150)">
                           <rect x="0" y="0" width="400" height="300" fill="#0f172a" stroke="#475569" strokeWidth="6" rx="10" />
                           <rect x="20" y="270" width="360" height="15" fill={isOutputOn('O:0/0') ? '#ef4444' : '#475569'} rx="5" />
                           <circle cx="200" cy="150" r="80" fill="#1e293b" stroke="#334155" strokeWidth="4" />
                           <g transform={`rotate(${isOutputOn('O:0/1') ? tick * 30 : 0} 200 150)`}>
                              <rect x="195" y="80" width="10" height="140" fill={isOutputOn('O:0/1') ? '#3b82f6' : '#64748b'} rx="5" />
                              <rect x="130" y="145" width="140" height="10" fill={isOutputOn('O:0/1') ? '#3b82f6' : '#64748b'} rx="5" />
                           </g>
                           <rect x="360" y="50" width="40" height="80" fill={physicalInputs['I:0/3'] ? '#ef4444' : '#22c55e'} rx="5" />
                           <text x="380" y="150" fill="white" fontSize="12" textAnchor="middle">Door</text>
                         </g>
                         <g transform="translate(40, 150)">
                           <rect width="300" height="280" fill="#0f172a" rx="10" stroke="#334155" strokeWidth="2" />
                           <text x="20" y="40" fill="#94a3b8" fontSize="16">Raw Input (D0): <tspan fill="white" fontWeight="bold">{dataRegisters['D0']} / 4095</tspan></text>
                           <text x="20" y="80" fill="#94a3b8" fontSize="16">Scaled Temp (D1): <tspan fill="#ef4444" fontWeight="bold">{dataRegisters['D1']} °C</tspan></text>
                           <text x="20" y="120" fill="#94a3b8" fontSize="16">Setpoint (D2): <tspan fill="white" fontWeight="bold">{dataRegisters['D2']} °C</tspan></text>
                           <text x="20" y="160" fill="#94a3b8" fontSize="16">Fan Speed (D5): <tspan fill="#3b82f6" fontWeight="bold">{dataRegisters['D5']} %</tspan></text>
                           <rect x="20" y="180" width="260" height="15" fill="#334155" rx="5" />
                           <rect x="20" y="180" width={(dataRegisters['D5']/100)*260} height="15" fill="#3b82f6" rx="5" />
                         </g>
                       </svg>
                     )}

                     {/* ---- ANALOG: PRESSURE ALARM ---- */}
                     {selectedPlant === 'pressureAlarm' && (
                       <svg viewBox="0 0 1000 600" className="w-full h-full object-contain">
                         <rect width="1000" height="600" fill="#1e293b" />
                         <text x="40" y="50" fill="white" fontSize="20" fontWeight="bold">Pressure Monitoring & Alarm</text>
                         <g transform="translate(450, 200)">
                           <rect x="0" y="0" width="200" height="300" fill="#0f172a" stroke="#cbd5e1" strokeWidth="8" rx="100" />
                           <rect x="80" y="50" width="40" height="200" fill="#334155" rx="5" />
                           <rect x="80" y={250 - (dataRegisters['D1']/10)*200} width="40" height={(dataRegisters['D1']/10)*200} fill={dataRegisters['D1']>=dataRegisters['D4']?'#ef4444':dataRegisters['D1']>=dataRegisters['D3']?'#facc15':'#22c55e'} rx="5" />
                         </g>
                         <g transform="translate(40, 150)">
                           <rect width="300" height="280" fill="#0f172a" rx="10" stroke="#334155" strokeWidth="2" />
                           <text x="20" y="40" fill="#94a3b8" fontSize="16">Raw Input (D0): <tspan fill="white" fontWeight="bold">{dataRegisters['D0']} / 4095</tspan></text>
                           <text x="20" y="80" fill="#94a3b8" fontSize="16">Pressure (D1): <tspan fill={dataRegisters['D1']>=dataRegisters['D4']?'#ef4444':'white'} fontWeight="bold">{dataRegisters['D1']} bar</tspan></text>
                           <text x="20" y="120" fill="#94a3b8" fontSize="16">Target (D2): <tspan fill="white" fontWeight="bold">{dataRegisters['D2']} bar</tspan></text>
                           <text x="20" y="160" fill="#94a3b8" fontSize="16">Warn Lim (D3): <tspan fill="#facc15" fontWeight="bold">{dataRegisters['D3']} bar</tspan></text>
                           <text x="20" y="200" fill="#94a3b8" fontSize="16">Crit Lim (D4): <tspan fill="#ef4444" fontWeight="bold">{dataRegisters['D4']} bar</tspan></text>
                         </g>
                         <circle cx="350" cy="400" r="25" fill={isOutputOn('O:0/0') ? '#22c55e' : '#475569'} />
                         <text x="350" y="405" fill="white" fontSize="10" fontWeight="bold" textAnchor="middle">COMP</text>
                         <rect x="700" y="250" width="40" height="40" fill={isOutputOn('O:0/1') || physicalInputs['I:0/3'] ? '#facc15' : '#475569'} rx="5"/>
                         <text x="720" y="275" fill="#1e293b" fontSize="10" fontWeight="bold" textAnchor="middle">RELIEF</text>
                       </svg>
                     )}
                  </div>
                )}
